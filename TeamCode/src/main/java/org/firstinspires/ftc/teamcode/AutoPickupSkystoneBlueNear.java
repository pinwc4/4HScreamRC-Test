...
@Autonomous(name = "AutoPickupSkystoneBlueNear")
@Disabled
public class AutoPickupSkystoneBlueNear extends OpMode {
    ...
    public void init(){
        ...
        */
        ...
        atsCurrentSegment = new AutonomousStrafeSidewaysSegment(AutoPickupSkystoneConstants.STEP_1_SIDEWAYS_DIST * AutoPickupSkystoneConstants.BLUE_SIDE_DIRECTION, 0,  dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);

        atsNextSegment = atsCurrentSegment;

        atsNewSegment = new AutonomousLocateSkystoneSegment(-AutoPickupSkystoneConstants.BLUE_SIDE_DIRECTION, 0, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, tfod, vuforia, msdMeasuredSkystoneDistance, imu);
        ...
        atsNewSegment = new AutonomousStrafeSidewaysSegment(AutoPickupSkystoneConstants.STEP_4_SIDEWAYS_DIST * AutoPickupSkystoneConstants.BLUE_SIDE_DIRECTION, 0, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
        ...
        atsNewSegment = new AutonomousStrafeSidewaysSegment(AutoPickupSkystoneConstants.STEP_7_SIDEWAYS_DIST_NEAR * AutoPickupSkystoneConstants.BLUE_SIDE_DIRECTION, 0, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
