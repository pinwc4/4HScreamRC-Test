...
@Autonomous(name = "AutoPickupSkystoneTest")
@Disabled
public class AutoPickupSkystoneTest extends OpMode {
    ...
    public void init(){
        ...
        */
        ...
        atsNewSegment = new AutonomousStrafeForwardSegment(-20, -88, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;

        atsNewSegment = new AutonomousStrafeCenterPivotSegment(-45, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
        ...
        atsNewSegment = new AutonomousStrafeForwardSegment(35, -45, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
        ...
        atsNewSegment = new AutonomousStrafeSidewaysSegment(22, -90, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
        ...
        atsNewSegment = new AutonomousStrafeForwardSegment(20, 90, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, msdMeasuredSkystoneDistance, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
        ...
        atsNewSegment = new AutonomousStrafeForwardSegment(7, 45, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, msdMeasuredSkystoneDistance, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
