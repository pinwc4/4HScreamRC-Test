...
@Autonomous(name = "AUTOVORTEXMoveToLineUG")

public class AUTOVORTEXMoveToLine extends OpMode {
    ...
    public void init(){
        ...
        */
        ...
        atsCurrentSegment = new AutonomousShootLauncherSegment( 0, 4000,  srvLauncherServo , telemetry);

        atsNextSegment = atsCurrentSegment;

        atsNewSegment = new AutonomousShootLauncherSegment( 0.5, 4000, srvLauncherServo, telemetry);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;

        atsNewSegment = new AutonomousShootLauncherSegment( 0, 4000, srvLauncherServo, telemetry);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
        ...
        atsNewSegment = new AutonomousStrafeForwardSegment(67, 0, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
