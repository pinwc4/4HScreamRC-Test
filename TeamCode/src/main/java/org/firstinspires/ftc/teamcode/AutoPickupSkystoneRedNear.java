...
@Autonomous(name = "AutoPickupSkystoneRedNear")
@Disabled
public class AutoPickupSkystoneRedNear extends OpMode {
    ...
    public void init(){
        ...
        */
        ...
        atsNewSegment = new AutonomousStrafeSidewaysSegment(AutoPickupSkystoneConstants.STEP_7_SIDEWAYS_DIST_NEAR * AutoPickupSkystoneConstants.RED_SIDE_DIRECTION, 0, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
