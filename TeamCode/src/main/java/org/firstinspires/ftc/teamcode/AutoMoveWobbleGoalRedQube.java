...
@Autonomous(name = "AutoMoveWobbleGoalRedQube")

public class AutoMoveWobbleGoalRedQube extends OpMode {
    ...
    public void start(){
        ...
        atsCurrentSegment = new AutonomousStrafeForwardSegment(52,0, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        ...
        atsNewSegment = new AutonomousSpinLauncherSegment( 2450, dcmLauncherMotor, telemetry);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
        ...
        atsNewSegment = new AutonomousShootLauncherSegment(0, 1000, srvLauncherServo, telemetry);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
