...
public class AutonomousDistanceSidewaysAWYSegment extends AutonomousSegment {
    ...
    public AutonomousDistanceSidewaysAWYSegment(double distToTravelin, double sensorDist, double dblDesiredHeading, DcMotor dcmFLMotor, DcMotor dcmFRMotor, DcMotor dcmBLMotor, DcMotor dcmBRMotor, Telemetry telemetry, BNO055IMU imu, DistanceSensor snsDistanceLeft, DistanceSensor snsDistanceRight) {
