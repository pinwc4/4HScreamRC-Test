...
public class AutonomousStrafeForwardWaitSegment extends AutonomousSegment {
    ...
    public AutonomousStrafeForwardWaitSegment(double distToTravelin, double dblDesiredHeading, DcMotor dcmFLMotor, DcMotor dcmFRMotor, DcMotor dcmBLMotor, DcMotor dcmBRMotor, Telemetry telemetry, BNO055IMU imu) {
