...
@Autonomous(name = "AutoMoveFoundationBlueFar")
@Disabled
public class AutoMoveFoundationBlueFar extends OpMode {
    ...
    public void init(){
        ...
        */
        ...
        atsNewSegment = new AutonomousStrafeSidewaysSegment(-30, 90, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
