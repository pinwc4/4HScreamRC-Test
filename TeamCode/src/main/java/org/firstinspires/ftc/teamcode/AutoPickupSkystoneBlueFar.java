...
@Autonomous(name = "AutoPickupSkystoneBlueFar")
@Disabled
public class AutoPickupSkystoneBlueFar extends OpMode {
    ...
    public void init(){
        ...
        */
        ...
        atsNewSegment = new AutonomousStrafeSidewaysSegment(AutoPickupSkystoneConstants.STEP_7_SIDEWAYS_DIST_FAR * AutoPickupSkystoneConstants.BLUE_SIDE_DIRECTION, 0, dcmFrontLeftMotor, dcmFrontRightMotor, dcmBackLeftMotor, dcmBackRightMotor, telemetry, imu);
        atsNextSegment.setNextSegment(atsNewSegment);
        atsNextSegment = atsNewSegment;
